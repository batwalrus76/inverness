...
get the app created:
    ...
    $ heroku apps:create inverness
    Creating inverness... done, stack is cedar
    http://inverness.herokuapp.com/ | git@heroku.com:inverness.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://inverness.herokuapp.com deployed to Heroku

    To git@heroku.com:inverness.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://inverness.herokuap.com
    ["Hello" :from Heroku]
